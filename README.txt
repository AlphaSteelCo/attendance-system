...
6. Open ⚙️ Settings -> Supabase.
7. Enter the Project URL and Publishable/Anon key, then save/connect.
8. Press the sync button. Existing local data will be uploaded if no cloud copy exists.
